...
metadata {
	...
	definition (name: "Gupta CT100 Thermostat (Convenience Mod)", namespace: "gupta", author: "Sandeep Gupta") {
		capability "Actuator"
	...
	tiles (scale: 2){
		...
		standardTile("fanMode", "device.thermostatFanMode", width:2, height:2, inactiveLabel: false, decoration: "flat") {
			state "auto",label:'',  action:"switchFanMode", nextState:"...", icon: "st.thermostat.fan-auto"
			state "on",label:'',  action:"switchFanMode", nextState:"...", icon: "st.thermostat.fan-on"
			state "circulate",label:'',  action:"switchFanMode", nextState:"...", icon: "st.thermostat.fan-circulate"
		...
		controlTile("heatSlider", "device.heatingSetpoint", "slider", width: 1, height: 2, range:"(45..105)") {
		...
		controlTile("coolSlider", "device.coolingSetpoint", "slider", width: 1, height: 2, range:"(45..105)") {
